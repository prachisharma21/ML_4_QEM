...
def data_storage_Folded_circuit(file_name = 'circ_0.pickle'):
    ...
    single_circ = data_loader('./pickles/' + file_name) 
    ...
    data_dict["ideal_expectation"] = single_circ['ideal_expectation'] 
    ...
    with open('./scaled_pickles/'+file_name.split(".")[0]+"_scaled.pickle", "wb") as f: 
